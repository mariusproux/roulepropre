      ...
      <div className="container-custom relative z-20">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-4 animate-fade-in flex flex-col justify-center order-2 md:order-1">
            ...
            <p className="text-base md:text-lg text-gray-600 max-w-xl leading-relaxed">Services de nettoyage automobile à votre domicile ou sur votre lieux de travail</p>
          ...
          <div className="flex justify-center items-center order-1 md:order-2">
            <div className="relative z-10 animate-scale-in">
              ...
              <img src="/lovable-uploads/c0bf4170-965e-40b7-b9cc-65555718f693.png" alt="ROULE PROPRE Logo" className="relative w-[280px] h-[280px] md:w-[350px] md:h-[350px] object-contain" />
            </div>
          </div>
        </div>
      </div>
