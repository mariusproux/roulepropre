...
import { BOOKING_SECTION_ID } from "@/lib/utils";
...
const SelectServiceSection = () => {
  ...
  // Logo en filigrane qui suit le scroll (parallaxe). Le hook ne calcule que
  // lorsque la section est visible et respecte prefers-reduced-motion.
  useParallax(sectionRef, (_scrollY, section) => {
